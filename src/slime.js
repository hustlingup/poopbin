...
export class MainScene {
  ...
  initFire() {
    ...
    const geometry = new THREE.ConeGeometry(1, 3, 64, 64, true); // Open ended
    ...
    const material = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          // Noise scrolling up
          float noise = snoise(vec3(position.x * 2.0, position.y * 2.0 + time * 2.0, position.z * 2.0));
          vNoise = noise;
    ...
    const material = new THREE.ShaderMaterial({
      ...
      vertexShader: `
        ...
        void main() {
          ...
          // Soft noise
          float noise = snoise(vec3(position.x * 0.5, position.y * 0.5 + time * 0.5, position.z * 0.5));
          vNoise = noise;
